...
La información contenida en este white paper es de naturaleza preliminar.
De esta manera, ni los autores ni ninguno de sus respectivos afiliados asumen responsabilidad alguna de que la información contenida en este white paper sea final o correcta y cada uno de los anteriores renuncia, en la medida máxima permitida por la legislación aplicable, a toda responsabilidad, ya sea que surja de agravio, por obligación contratual o extracontractual o de cualquier otra manera en relación con este documento.
Ninguna parte de este documento ni la información contenida en el mismo deberán constituir la base de, o ser utilizada en relación con, o actuar como incentivo para entrar en cualquier contrato o compromiso de ninguna naturaleza.

Nada en este documento constituye una oferta de venta o una solicitud de compra de cualquier de los tokens que se mencionan en él.
En cualquier evento, si este documento se considerara una oferta o solicitud, ninguna de ellas se pretende o se transmite por este documento en ninguna jurisdicción en la que dicho acto sea ilegal,
donde este tipo de oferta o solicitud requieriera de una licencia o registro, o donde este tipo de oferta o solicitud estuviera sujeta a restricciones.
En particular, cualquier token mencionado en este documento no ha sido y, a la fecha de emisión de este documento, no está destinado a ser registrado bajo las Leyes de Valores o similares de ninguna jurisdicción,
ya sea que dicha jurisdicción considere que tales tokens sean un instrumento de valor financiero o similar o no, y no pueden ofrecerse o venderse en ninguna jurisdicción en la que hacerlo constituiría una violación de las leyes relevantes de dicha jurisdicción.

# Licencia

El código fuente[^src] de este documento está disponible bajo la licencia Creative Commons Attribution-ShareAlike 4.0 International[^cc].
...
Internet está compuesta principalmente por proyectos de código abierto y ha sido así desde su creación.
Con el tiempo, muchos de estos proyectos se han convertido en piezas fundacionales sobre las que se erige todo el futuro de la innovación.
Y aunque se han hecho fortunas en base a él, el código abierto se crea y se mantiene principalmente sin compensación alguna.

Nosotros creemos que la totalidad de la empresa humana moderna se ha estancado por depender de que una ínfima parte de los ingenieros alrededor del mundo elija entre percibir un salario o mantener Internet funcionando.
El código abierto es un trabajo de amor a menudo obstaculizado por la falta de incentivos económicos significativos, resultando en proyectos genuinamente valiosos que nunca alcanzan su verdadero potencial, mientras que otros sufren de problemas de seguridad debido a la falta de incentivos para continuar manteniendo el software a lo largo de su ciclo de vida.
Para poder aprovechar todo el potencial, necesitamos un sistema de remuneración para el ecosistema de código abierto que sea justo y que, a su vez, no cambie de manera fundamental la forma en que éste se desarrolla o utiliza.
